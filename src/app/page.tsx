  ...
  >
    ...
    <div className="relative mx-auto max-w-3xl text-center">
      ...
      <p className="mx-auto mt-6 max-w-2xl text-lg leading-relaxed text-blue-200 lg:text-xl">
        Your contributions help us reach more students, host impactful conferences, and create initiatives that shape future leaders. Partner with us in transforming the campus for Christ.
      </p>
      <a
        href="#"
        className="mt-8 inline-block rounded-3xl bg-white px-10 py-4 text-xl font-black text-indigo-900 shadow-2xl transition-shadow hover:shadow-3xl"
      >
        Donate Now
      </a>
    </div>
